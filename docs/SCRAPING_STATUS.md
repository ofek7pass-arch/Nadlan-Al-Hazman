...
| מקור | עובד? | הערות |
|------|--------|-------|
| יד2 | ❌ לא ידוע | Puppeteer עולה, לא נבדק אם חילוץ עובד |
| מדלן | ❌ לא ידוע | Puppeteer עולה, לא נבדק אם חילוץ עובד |
| טלגרם | ✅ עובד | אבל `telegramChannels: []` — המשתמש צריך להוסיף קנלים מחדש |
